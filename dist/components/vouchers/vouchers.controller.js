...
let VouchersController = class VouchersController {
    ...
    getAllVouchers(merchantID, deal, amount, fee, net, status, paymentStatus, dateFrom, dateTo, voucherID = "", dealHeader = "", voucherHeader = "", voucherStatus = "", invoiceStatus = "", offset = 0, limit = 10, multipleVouchersDto) {
        return this.voucherService.getAllVouchersByMerchantID(deal, amount, fee, net, status, paymentStatus, dateFrom, dateTo, merchantID, voucherID, dealHeader, voucherHeader, voucherStatus, invoiceStatus, offset, limit, multipleVouchersDto);
    }
...
__decorate([
    ...
    __param(9, (0, common_1.Query)("voucherID")),
    __param(10, (0, common_1.Query)("dealHeader")),
    __param(11, (0, common_1.Query)("voucherHeader")),
    __param(12, (0, common_1.Query)("voucherStatus")),
    __param(13, (0, common_1.Query)("invoiceStatus")),
    __param(14, (0, common_1.Query)('offset')),
    __param(15, (0, common_1.Query)('limit')),
    __param(16, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, String, String, String, Number, Number, String, String, String, String, String, Number, Number, multiplevouchers_dto_1.MultipleVouchersDto]),
    __metadata("design:returntype", void 0)
